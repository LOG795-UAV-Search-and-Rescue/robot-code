...
cron_job1="@reboot sleep 1 && whoami && pulseaudio --start && sleep 1 && XDG_RUNTIME_DIR=/run/user/$(id -u) ~/robot-code/ugv_server/ugv-env/bin/python ~/robot-code/ugv_server/app.py >> ~/ugv.log 2>&1"
